...
<html>
<head>
<title>Linux(Fedora) Tip Sheet</title>
...
<h1>Cyberpatriot Linux(Fedora) Tip Sheet</h1>
...
$query = "SELECT * FROM comp_log WHERE team_id='". $_SESSION['team_id'] . "' AND os='fedora' AND round_id=(SELECT round_id FROM rounds WHERE team_id='" . $_SESSION['team_id'] . "')";
...
<script type="text/javascript">
  $('.thecheckbox').change(function(e){
    ...
    data = {id: rowid, active: isChecked, os: 'fedora'};
