...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  elseif ($password == '') {
    ...
    $query = "SELECT * FROM sq_members WHERE cap_id=$capid && cp=1";
...
<style>
  ...
  body{
    background-image:url('images/neo.gif'); background-repeat:repeat;
  }

  input {
    background-color: #04bd0d
  }
  ...
  <body>
    <div class="loginform">
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" accept-charset="UTF-8">
        ...
        <input type="text" name="capid" align="right" value="<?PHP if(isset($_POST['capid'])) echo htmlspecialchars($_POST['capid']); ?>"><br>
        <input type="password" name="password" align="right" value="<?PHP if(isset($_POST['password'])) echo htmlspecialchars($_POST['password']); ?>"><br><br>
